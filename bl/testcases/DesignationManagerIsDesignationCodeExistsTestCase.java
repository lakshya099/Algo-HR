...
import java.util.*;
class DesignationManagerIsDesignationCodeExistsTestCase
{
public static void main(String gg[])
{
try
{
System.out.println(DesignationManager.getDesignationManager().isDesignationCodeExists(Integer.parseInt(gg[0])));
